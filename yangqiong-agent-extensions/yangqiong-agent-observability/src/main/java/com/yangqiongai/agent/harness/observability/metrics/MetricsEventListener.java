...
import com.yangqiongai.agent.harness.event.AgentEventListener;
...
public final class MetricsEventListener implements AgentEventListener {
    ...
    private List<AgentToolResultBlock> extractToolResultBlocks(Object payload) {
        ...
        if (first instanceof com.yangqiongai.agent.harness.core.message.AgentMessage) {
            List<AgentToolResultBlock> blocks = new java.util.ArrayList<>();
            for (Object item : list) {
                com.yangqiongai.agent.harness.core.message.AgentMessage message =
                        (com.yangqiongai.agent.harness.core.message.AgentMessage) item;
                if (message == null || message.getContent() == null) {
                    continue;
                }
                for (com.yangqiongai.agent.harness.core.message.AgentContentBlock block : message.getContent()) {
