...
import com.yangqiongai.agent.harness.local.knowledge.FsKnowledgeBase;
...
import com.yangqiongai.agent.harness.local.model.LocalModelEndpointType;
import com.yangqiongai.agent.harness.local.model.LocalModels;
import com.yangqiongai.agent.harness.local.model.OllamaEmbeddingModel;
import com.yangqiongai.agent.harness.local.permission.LocalShellPolicyGate;
...
import com.yangqiongai.agent.harness.local.tool.LocalShellTool;
import com.yangqiongai.agent.harness.local.tool.LocalTextDocumentParser;
import com.yangqiongai.agent.harness.local.workspace.FsSkillBox;
import com.yangqiongai.agent.harness.local.workspace.HealthWatchdog;
import com.yangqiongai.agent.harness.local.workspace.KnowledgeMaintainer;
import com.yangqiongai.agent.harness.local.workspace.LocalWorkspace;
import com.yangqiongai.agent.harness.local.workspace.MemoryConsolidator;
import com.yangqiongai.agent.harness.local.workspace.SessionTranscriptStore;
import com.yangqiongai.agent.harness.local.workspace.SkillDistiller;
import com.yangqiongai.agent.harness.local.workspace.TranscriptAutoSynchronizer;
...
public final class LocalAgentHarness {
    ...
    private static void wireWorkspaceSync(HarnessRuntimeBuilder builder, LocalHarnessConfig config,
        ...
        com.yangqiongai.agent.harness.core.skill.AgentSkillBox skillBox =
