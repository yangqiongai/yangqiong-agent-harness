 ...
 * 本地文本解析器
 * <p>
 * 在引擎默认纯文本解析器基础上扩展常见代码文件扩展名（css/js/ts/java/py等），
 * 使 file_read 等文件工具可直接读取代码类纯文本文件，避免Agent降级到shell读取。
 * </p>
 * @author yangqiong
 */
public class LocalTextDocumentParser implements DocumentParser {
    ...
    private static final String[] TEXT_EXTENSIONS = {
            ...
            "css", "scss", "less", "js", "mjs", "cjs", "jsx", "ts", "tsx", "java", "kt", "py", "go", "rs",
            "c", "h", "cpp", "hpp", "sql", "sh", "bat", "cmd", "ps1", "ini", "conf", "cfg", "gradle", "vue"
    };
