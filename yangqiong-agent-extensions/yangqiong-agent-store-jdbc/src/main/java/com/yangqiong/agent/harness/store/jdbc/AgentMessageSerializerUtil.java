...
final class AgentMessageSerializerUtil {
     ...
     * @return
     */
    static String messagesToJson(List<com.yangqiong.agent.harness.core.message.AgentMessage> messages) {
     ...
     * @return
     */
    static List<com.yangqiong.agent.harness.core.message.AgentMessage> messagesFromJson(String json) {
