...
class RuntimeCustomizerAndAgentLoopTest {
    ...
    void addCustomizer_shouldBeAppliedBeforeBuild() {
        ...
        runtime.stream(List.of(com.yangqiongai.agent.harness.core.message.MessageFactory.createUserMessage("hi")),
                com.yangqiongai.agent.harness.engine.AgentRuntimeContext.empty()).blockLast();
