...
class ApprovalModeWiringTest {
    ...
    private static class ToolCallingStubModel implements AgentModel {
        ...
        @Override
        public AgentChatResponse generate(List<com.yangqiongai.agent.harness.core.message.AgentMessage> messages,
        ...
        @Override
        public Flux<AgentChatResponse> stream(List<com.yangqiongai.agent.harness.core.message.AgentMessage> messages,
                                              List<Map<String, Object>> tools, AgentGenerateOptions options) {
