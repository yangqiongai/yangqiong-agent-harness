 ...
 * @author yangqiong
 */
public class TestMiddlewareProvider implements MiddlewareProvider {
    ...
    public TestMiddlewareProvider() {
        CONSTRUCT_COUNT.incrementAndGet();
    }

    @Override
    public List<AgentMiddleware> provideMiddlewares() {
        return List.of(new AgentMiddleware() {
        });
    }
}